...
const Product = () => {
  ...
  return (
      <>
      <h1 className='text-center text-2xl my-5'>MUSIC CATEGORY</h1>
      <div className='grid lg:grid-cols-5 grid-cols-1 gap-4 lg:p-0 p-5'>
      {collection.map((item, i) => (
        <div onClick={() => productDetail(item)} className='bg-white rounded-lg p-5 shadow-md lg:p-4  cursor-pointer' key={i}>
